        ...
        actions: [
          {
            ...
            handler: function(data) {
              console.log('input:root', data)
            }
          },
          {
            trigger: 'change',
            handler: function(data) {
              console.log('change:root', data)
            }
          }
        ],
        on: {
          input: (data) => {
            console.log('root-input-on', data)
          }
        },
        properties: {
          test: {
              ...
              actions: [
                {
                  trigger: 'input',
                  handler: function(data) {
                    console.log('array-input:data', data)
                  }
                }
              ],
              on: {
                'input change': function(data) {
                  console.log('array-change:data', data)
                }
              }
            },
